...
Replace this section with the supported versions for `reviewcue`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `reviewcue` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in reviewcue.
